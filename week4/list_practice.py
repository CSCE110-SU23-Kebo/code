...
# .count()
new_airports = ['LAX', 'CHI', 'OMA', 'CDG', 'COO', "CLL", 'COO', "CLL"]
# Count the number of specific items in a list
print(f"Count of airports: {new_airports.count('COO')}")

# .remove()
# Remove a specific item from a list
new_airports.remove("CLL")
print(f"Updated airport list: {new_airports}")

# Sorting a list
# Example sort the list of airports in ascending or descending order

new_airports.sort()
print(f"Updated airport list - sort(): {new_airports}")

new_airports.sort(reverse=True)
print(f"Updated airport list - sort(reverse=True): {new_airports}")

new_airports.sort(reverse=False)
print(f"Updated airport list - sort(reverse=False): {new_airports}")

# Update the list of airports
planets = ['PLUTO', 'MARS', 'JUPITER', 'SATURN', 'VENUS']
new_airports.extend(planets)
print(f"Updated airport list: {new_airports}")

new_airports.sort(key=len)
print(f"Updated airport list - sort(key=len): {new_airports}")
